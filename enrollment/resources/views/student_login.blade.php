                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form method="POST" action="{{ url('/studentlogin') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control p_input" name="student_email" placeholder="Input your Email" required>
                            </div>
                            <div class="form-group">
                                <label>Password *</label>
                                <input type="password" class="form-control p_input" name="student_password" placeholder="Password Here" required>
                            </div>
