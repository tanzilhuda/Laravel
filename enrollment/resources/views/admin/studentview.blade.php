            ...
            <div class="col-lg-12 side-left">
                <div class="card mb-4">
                    <div class="card-body avatar">
                        ...
                        <img src="{{asset($student_description_profile->student_image)}}" alt="missing image" width="47" height="47">
                    ...
                    <div class="card-body overview">
                        ...
                        <div class="info-links">
                            <a class="website">
                                ...
                                <span style="font-family: Verdana; font-size: 15px">{{$student_description_profile->student_fathername}}</span>
                            </a>
                            <a class="website">
                                <i class="icon-globe icon">Mother's name:</i>
                                <span style="font-family: Verdana; font-size: 15px">{{$student_description_profile->student_mothername}}</span>
                            </a>
                            <a class="website">
                            ...
                            <a class="website">
                                ...
                                <span style="font-family: Verdana; font-size: 15px">
                                    {{($student_description_profile->student_admissionyear)}}</span>
                            </a>
                        </div>
                    </div>
                </div>
