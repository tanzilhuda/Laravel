                                ...
                                <table id="order-listing" class="table table-striped" style="width:100%;">
                                 ...
                                 @foreach($allstudent_info as $student)
                                    <tr>
                                        ...
                                        <td style="width: 24%">
                                            <a href="{{URL::to('/student_view/'.$student->student_id)}}"><button class="btn btn-outline-primary">View</button></a>
                                            <a href="{{URL::to('/student_edit/'.$student->student_id)}}"><button class="btn btn-outline-warning">Edit</button></a>
                                            <a id="delete" href="{{URL::to('/student_delete/'.$student->student_id)}}">
